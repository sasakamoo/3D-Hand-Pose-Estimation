...
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
#SBATCH --time=0-00:59        # 30 minutes is plenty for 400 iters
...
#     --save_dir     "$SAVE_DIR"
python ./main/overfit_test.py \
    --resume /home/kghasemz/projects/def-vislearn/kghasemz/HOISDF/outputs/model_dump/freihand_run1/snapshot_5_1331.pth.tar \
